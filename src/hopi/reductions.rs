...
pub fn normalize_process(p: Process) -> Process
{
    match p {
        Process::End => p,
        Process::PVar(_) => p,
...
pub fn chn_alpha_conversion(p: Process, c_from: String, c_to: String) -> Result<Process, String>
{
...
pub fn var_free_names(p: &Process) -> HashSet<String>
{
...
pub fn tag_free_names(_p: &Process) -> Vec<String>
{
    todo!()
}
